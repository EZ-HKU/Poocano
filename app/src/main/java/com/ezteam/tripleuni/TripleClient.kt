...
class TripleClient {
    ...
    private fun getList(topic: String): JSONObject? {
        var url = "https://eo.api.$domain/v4/post/list/all.php"
        ...
        if (topic != "全部") {
            url = "https://eo.api.$domain/v4/post/list/topic.php"
    ...
    fun getProfile(): JSONObject? {
        ...
        val request = Request.Builder().url("https://eo.api.$domain/v4/user/profile/get.php")
    ...
    fun getDetail(id: String): JSONObject? {
        ...
        val detailData =
            FormBody.Builder().add("uni_post_id", id).add("token", token).add("language", "zh-CN")
                .build()
        val request = Request.Builder().url("https://eo.api.$domain/v4/post/single/get.php")
    ...
    fun sendVerification(email: String): Boolean {
        ...
        val request =
            Request.Builder().url("https://eo.api.$domain/v4/user/register/web/email.php")
    ...
    fun sendComment(content: String, postId: String): Boolean {
        ...
        val request = Request.Builder().url("https://eo.api.$domain/v4/comment/post.php")
    ...
    fun postPoster(
        ...
        val request = Request.Builder().url("https://eo.api.$domain/v4/post/single/post.php")
    ...
    fun verifyCode(vcode: String): Boolean {
        ...
        val request =
            Request.Builder().url("https://eo.api.$domain/v4/user/register/web/verify.php")
    ...
    fun reportPost(
        ...
        val request = Request.Builder().url("https://eo.api.$domain/v4/post/single/report.php")
    ...
    fun followPost(uniPostId: String): Int {
        ...
        val request = Request.Builder().url("https://eo.api.$domain/v4/post/single/follow.php")
